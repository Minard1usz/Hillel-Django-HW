...
class StoreAPITestCase(APITestCase):
    ...
    def test_jwt_obtain_token_success(self):
        ...
        response = self.client.post(
            self.token_url, {"username": "user", "password": "password123"}
        )
    ...
    def test_jwt_obtain_token_invalid_password(self):
        ...
        response = self.client.post(
            self.token_url, {"username": "user", "password": "wrong"}
        )
    ...
    def test_get_book_detail(self):
        ...
        self.assertEqual(
            response.data["category_detail"]["name"], "Sci-Fi"
...
class CartAndOrderAPITestCase(APITestCase):
    ...
    def test_create_order_empty_cart_fails(self):
        ...
        self.assertEqual(
            response.data["error"],
            "Ваш кошик порожній. Немає товарів для оформлення замовлення.",
        )
    ...
    def test_create_order_success(self):
        ...
        cart_response = self.client.post(
            self.cart_add_url, {"book_id": self.book.id, "quantity": 2}
        )
